...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/10 15:37:07 by amagno-r          #+#    #+#             */
/*   Updated: 2025/12/10 15:37:08 by amagno-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handle_variable_state(t_quote_machine *sm, t_envp *env,
		int last_status)
{
	char	*var;
	...
	else if ((sm->ch == '"' && sm->prev != IN_DQ) || (sm->ch == '\''
			&& sm->prev != IN_SQ))
		sm_laststate(sm);
	else
	{
